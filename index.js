...
// ans = gmail.com
const myEmailSliceValue2 = myEmail.slice(
  myEmail.indexOf("@") + 1,
  myEmail.indexOf(".")
);
...
const myMethodChainingValue0 = myName
  .slice(0, myName.indexOf(" "))
  .toUpperCase();
...
function Sum(Callback, x, y) {
  console.log(
    "ami holam sum function amar pore akdom must dislay function result korbe"
  );
  let result = x + y;
  Callback(result);
}
...
const hello1 = (name, age) =>
  console.log(`hello world ${name}, your age is ${age}`);
...
const fruitsm = ["apple", "banana", "mango"];
